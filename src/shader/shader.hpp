...
class Shader {
   public:
    ...
    void setSpotLight(const std::string name, glm::vec3 pos,
                      glm::vec3 direction, glm::vec3 ambient, glm::vec3 diffuse,
                      glm::vec3 specular, float cutOff, float outerCutOff,
                      float constant, float linear, float quadratic);
    void setPointLight(const std::string name, glm::vec3 pos, glm::vec3 ambient,
                       glm::vec3 diffuse, glm::vec3 specular, float constant,
                       float linear, float quadratic);
    void setDirLight(const std::string name, glm::vec3 direction,
